...
export default async function OurServices() {
  ...
  return (
    <div className=" min-h-screen bg-gray-50 text-gray-800">
      <PageHeader
        title="Transforming Data Into Strategic Growth"
        subtitle="Empowering businesses to make smarter decisions through data,
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {services.map((service) => (
                <Link key={service.slug} href={`/services/${service.slug}`}>
                  <div className="bg-gray-50 rounded-2xl shadow-md p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
