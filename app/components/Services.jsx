  ...
  return (
    <section class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-6 text-center">
        <h2 class="text-3xl font-bold text-[#1E2A38] mb-8">
          Our Core Services
        </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="bg-gray-50 p-8 rounded-lg shadow-sm">
            <div className="rounded-full p-3 w-fit bg-white shadow-md mx-auto mb-4">
              <img className="h-16" src="/case-study.png" alt="Brokerage Services" />
            </div>
          ...
          <div class="bg-gray-50 p-8 rounded-lg shadow-sm">
            <div className="rounded-full p-3 w-fit bg-white shadow-md mx-auto mb-4">
              <img className="h-16" src="/broker.png" alt="Brokerage Services" />
            </div>
            <h3 class="text-xl font-semibold mb-3">
          ...
          <div class="bg-gray-50 p-8 rounded-lg shadow-sm">
            <div className="rounded-full p-3 w-fit bg-white shadow-md mx-auto mb-4">
              <img className="h-16" src="/risk-management.png" alt="Risk Management" />
            </div>
            <h3 class="text-xl font-semibold mb-3">
              Fraud Analytics & Risk Management
            </h3>
            <p class="text-gray-600">
              Fraud erodes trust and profitability we help you stay ahead of
              it. Our data-driven fraud analytics framework identifies
              suspicious patterns, enhances transaction monitoring, and
              strengthens fraud defense mechanisms.
            </p>
          </div>
        </div>
      </div>
