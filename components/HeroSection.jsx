...
const HeroSection = () => {
  return (
    <section className="bg-linear-to-br from-slate-900 via-blue-900 to-indigo-800 text-white flex flex-col-reverse md:flex-row py-20 md:py-32 relative z-10 gap-10 pb-10">
